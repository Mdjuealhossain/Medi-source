                    ...
                    <div className="relative flex xl:gap-20 lg:gap-16 md:gap-12">
                        ...
                        <div className="hidden md:block bg-white w-300 py-8 rounded-lg">
                            <div className="flex flex-col items-center justify-center gap-1 mb-6">
                                <div className="w-16 h-16 rounded-full flex items-center justify-center overflow-hidden border-2 border-warning_main">
...
const options = [
    ...
    { name: "Delete This Account", icon: <AiOutlineDelete className="text-warning_main text-subtitle1" />, url: "/order-history" },
    { name: "privacy policy", icon: <MdOutlinePrivacyTip className="text-warning_main text-subtitle1" />, url: "/privacy-policy" },
    { name: "Terms of Service", icon: <TbAirConditioning className="text-warning_main text-subtitle1" />, url: "/terms" },
    { name: "JavaScript", icon: <SiOpenjsfoundation className="text-warning_main text-subtitle1" />, url: "/js" },
];
