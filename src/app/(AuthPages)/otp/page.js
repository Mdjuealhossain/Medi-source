                            ...
                            <div>
                                <div className="mb-5">
                                    ...
                                    <div className="flex gap-3 xs:gap-6 h-8 items-center justify-between">
                                        {otp.map((_, index) => (
                                            <input key={index} id={`otp-${index}`} type="text" maxLength="1" value={otp[index]} onChange={(e) => handleChange(e.target.value, index)} onKeyDown={(e) => handleKeyDown(e, index)} className={`rounded bg-transparent ring-1 ring-divider text-center h-8 w-8 focus:outline-none focus:ring-1 focus:ring-warning_main`} />
                                        ))}
                                    </div>
                                </div>
                                ...
                                <div className="mb-3 lg:mb-6">
                                    <Link href={"/"}>
                                        <Button className={"bg-warning_main w-full hover:bg-warning_dark text-white capitalize"}> Verify Code</Button>
                                    </Link>
                                </div>
                            </div>
                        </form>
